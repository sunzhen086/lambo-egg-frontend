...
import testUser1Query from '@/components/testUser1/TestUser1Query';
import testUser1Edit from '@/components/testUser1/TestUser1Edit';
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'manage/testUser1/query',
            meta:{
          title: 'testUser1Query',
        },
          name:'testUser1Query',
            component: testUser1Query
        },
        {
          path: 'manage/testUser1/edit',
            meta:{
          title: 'testUser1Edit',
        },
          name:'testUser1Edit',
            component: testUser1Edit
        }
      ]
    }
  ]
