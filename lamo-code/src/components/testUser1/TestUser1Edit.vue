    ...
    export default {
        ...
        methods: {
            ...
            formSubmit(){
                ...
                if(self.userId) {  //修改
                    util.ajax.post("/manage/testUser1/update/" + self.userId, params).then(function(resp) {
                        self.$Message.success('保存成功');
                        self.pageGoBack();
                    })
                } else { //新增
                    util.ajax.post("/manage/testUser1/create", params).then(function(resp) {
            ...
            initData:function(){
                ...
                //初始化数据
                if(self.userId) { //修改
                    util.ajax.get("/manage/testUser1/get/" + self.userId).then(function(resp) {
