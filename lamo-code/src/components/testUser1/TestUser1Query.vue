<template>
    <div>
        <Card>
            <div slot="extra"></div>
            <LamboTable ref="table" dataUrl="/manage/testUser1/list" :columns="tableColumn" :searchParams="tableSearchParams">
                <div slot="search">
        ...
        methods:{
            ...
            doDelete: function(userId) {
                ...
                this.$Modal.confirm({
                    ...
                    content: '<p>确定要删除吗?</p>',
                    onOk:() => {
                        util.ajax.get("/manage/testUser1/delete/"+ userId).then(function(resp) {
