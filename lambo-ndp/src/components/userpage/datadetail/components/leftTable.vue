...
<script>
  import queryCondition from '@/components/userpage/datadetail/tools/query/query';
  import codeModal from '@/components/userpage/datadetail/tools/codeModal/codeModal';
  export default {
    name: "left-table",
    data(){
      return{
